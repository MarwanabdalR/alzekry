                    ...
                    >
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-[17px] font-bold text-[#0f172a]">{t(`areas.${area.key as any}.category`)}</h3>
                            </div>
                            <motion.div
                        ...
                        >
                            <ul className="px-6 pb-5 pt-1 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-2.5">
                                {(t.raw(`areas.${area.key as any}.services`) as string[]).map((service, serviceIndex) => (
